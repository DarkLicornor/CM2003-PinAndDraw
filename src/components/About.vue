...
<template>
  <div class="aboutText">
    ...
    <p>Spicy jalapeno bacon ipsum dolor amet ball tip tenderloin dolore alcatra,
    ...
    <p>Capicola sed boudin voluptate, bresaola doner ex aliquip shank ut magna
    ...
    <p>Bresaola boudin pig, voluptate jowl laboris cillum tri-tip short ribs non
    ...
    <p>Commodo aute turkey fugiat biltong. Aliqua pig magna, andouille pork chop
    ...
    <p>Salami porchetta pork enim ad venison, consectetur pork loin fatback est
